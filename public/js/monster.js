const ZONES = [
  {
    ...
    monsters: [
      ...
      { name: '野狼', level: 2, hp: 140, atk: 26, def: 16, dropSlot: 'accessory', sprite: 'wolf', expReward: 30, goldReward: 15 },
      { name: '妖精', level: 2, hp: 160, atk: 28, def: 20, dropSlot: 'helmet', sprite: 'fairy', expReward: 35, goldReward: 17 },
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: '骷髅兵', level: 5, hp: 340, atk: 68, def: 36, dropSlot: 'accessory', sprite: 'skeleton', expReward: 100, goldReward: 50 },
      { name: '暗精灵', level: 5, hp: 340, atk: 70, def: 40, dropSlot: 'helmet', sprite: 'dark-elf', expReward: 120, goldReward: 55 },
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: '蝎子王', level: 10, hp: 600, atk: 160, def: 25, dropSlot: 'accessory', sprite: 'scorpion-king', expReward: 270, goldReward: 130 },
      { name: '沙虫', level: 11, hp: 600, atk: 210, def: 30, dropSlot: 'helmet', sprite: 'sand-worm', expReward: 300, goldReward: 150 },
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: '巫妖', level: 16, hp: 780, atk: 840, def: 40, dropSlot: 'accessory', sprite: 'lich', expReward: 530, goldReward: 280 },
      { name: '吸血鬼', level: 17, hp: 550, atk: 1680, def: 45, dropSlot: 'helmet', sprite: 'vampire', expReward: 600, goldReward: 310 },
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: '深渊领主', level: 22, hp: 2500, atk: 1640, def: 70, dropSlot: 'accessory', sprite: 'abyss-lord', expReward: 950, goldReward: 480 },
      { name: '恶魔', level: 23, hp: 1450, atk: 4600, def: 80, dropSlot: 'helmet', sprite: 'demon', expReward: 1050, goldReward: 520 },
